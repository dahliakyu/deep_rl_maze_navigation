...
# Configuration
files = ['./results/auto_gen_TD/sarsa_9x9_comp_15_a_0.1_g_0.9_e_0.1.json',  # SARSA file
         './results/auto_gen_TD/ql_9x9_comp_15_a_0.1_g_0.9_e_0.1.json']    # Q-Learning file
